...
function addTable() {
    ...
    $('#divFAPress')
        .append($(
            ...
            .remaxes +
            ")'> <img src='https://media.innogamescdn.com/com_DS_FR/Scripts/Pillage/attacks.png' title='στο δρόμο' alt='' class='tooltip' /> Στο δρόμο <input type='text' id='txtNbAttacks' size='2' maxlength='2' value='" + userset[pos.s.MaxNbAttacks] + "' onchange='onlyNum(this)' disabled>
            <input type='checkbox' id='chbRemBlue' onclick='return chkBoxClick($(this).is(\":checked\"), " +
            pos.s.remblue +
